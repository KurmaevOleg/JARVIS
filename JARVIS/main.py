...
COMMAND_HELP = [
    ...
    ("Файлы", "создай документ / создай ворд документ", "Создает и открывает .docx"),
    ...
    ("Экран", "сделай скриншот и <вопрос>", "Отправляет скриншот в vision model с вашим вопросом"),
    ("Экран", "найди кнопку ... на экране", "Подсказывает по видимым элементам интерфейса"),
